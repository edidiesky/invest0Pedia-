...
export default function CreateInvestment() {
  ...
  const inputData = [
    {
      id: 1,
      name: "price",
      placeholder: "Create Investment Price",
      type: "number",
      text: "Create Investment Price",
    },
    {
      id: 2,
      name: "profit",
      placeholder: "Create Investment Profit",
      type: "number",
      text: "profit",
    },
    {
      id: 3,
      name: "rate",
      placeholder: "Create Investment rate",
      type: "number",
      text: "rate",
    },
    {
      id: 4,
      name: "volume",
      placeholder: "Create Investment volume",
      type: "number",
      text: "volume",
    },
    {
  ...
  const handleCreateInvestPlan = (e) => {
    e.preventDefault();
    dispatch(AdminCreateInvestment(formdata));
  };
  ...
  return (
    <>
      ...
      {/* <Header text={"Customer CreateInvestment"} /> */}
      <MarketContainer>
        <div className="profileWrapper">
          ...
          <div className="EditMarketWrapperTopLeft ">
            <h3>Manage CreateInvestment</h3>
            
          </div>

          <form className="profileForm shadow" onSubmit={handleCreateInvestPlan}>
